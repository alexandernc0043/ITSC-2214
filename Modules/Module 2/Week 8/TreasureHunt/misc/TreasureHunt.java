...
public class TreasureHunt {
     ...
     *               be inserted
     * @param after The existing location before which the new location will
     *               be inserted
     */
    public void insert(String newLocation, boolean newHasTreasure,
        ...
        //b) Make a new location node and insert the new node between two existing locations
    ...
    public void remove(Predicate<LocationNode> p) {
        ...
        while (cur != null) {
            if (p.test(cur)) {//True branch: locate the locationNode satifying the condition
                //TODO Remove the identified node with the following three cases into consideration
                // 1) If the identified node is the first node of the map, 
                //    we need to remove this node and change the first reference variable to reflect the change after removing
                // 2) If the identified node is the last node of the map, 
                //    we need to remove this node and change the last reference variable to reflect the change after removing
    ...
    public static void main(String[] argv) {
        ...
        map.traverse();
        map.insert("Cave  of Wonders", true,
                "Forest", "Riverbank");
